...
更偏「配置与接入」的通用设计见 [`dependency-aware-testing.md`](../dependency-aware-testing.md)；AxVisor 案例见 [`axvisor-case-study.md`](../axvisor-case-study.md)。
...
规则字段详解见 [`configs/test-target-rules.json`](../configs/test-target-rules.json) 旁白及 [`dependency-aware-testing.md` 第 4 节](../dependency-aware-testing.md#4-规则模型test-target-rulesjson)。
...
- [依赖感知通用设计](../dependency-aware-testing.md)
- [AxVisor 案例](../axvisor-case-study.md)
- [README · Test 与本地 `--auto-target`](../README.md#test)
